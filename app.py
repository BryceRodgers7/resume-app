...
def home_page():
    ...
    You can view the source code for this application <a href="https://github.com/BryceRodgers7/resume-app">here</a> or check out <a href="/architecture">this</a> schematic of the application architecture, and be sure to scroll all the way to the bottom for a list of deployed features on this site & the technologies used.
    </p>
    """, unsafe_allow_html=True)
